-- V14: Update investigation_records progress_status check constraint
-- This migration updates the progress_status constraint to match the new PROGRESS_STATUS enum values
